    ...
    return (
      <DragDropContext onDragEnd={this.onDragEnd}>
            ...
            {(provided, snapshot) => (
              ...
              >
                {this.state.planner.modules
                  ? this.state.planner.modules.map((module, index) => (
                      <Draggable
                        key={module.code}
        ...
        <div className={classes.PlanCardContainer}>
          <PlanCard droppableId="y1s1" array={this.state.planner.y1s1} />
          <PlanCard droppableId="y1s2" array={this.state.planner.y1s2} />
          <PlanCard droppableId="y2s1" array={this.state.planner.y2s1} />
          <PlanCard droppableId="y2s2" array={this.state.planner.y2s2} />
          <PlanCard droppableId="y3s1" array={this.state.planner.y3s1} />
          <PlanCard droppableId="y3s2" array={this.state.planner.y3s2} />
          <PlanCard droppableId="y4s1" array={this.state.planner.y4s1} />
          <PlanCard droppableId="y4s2" array={this.state.planner.y4s2} />
        </div>
      </DragDropContext>
    );
  }
